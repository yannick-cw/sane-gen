...
class FileReaderSpec extends FlatSpec with Matchers with Inspectors with OptionValues {
  ...
  it should "read all first names" in (FileReader.firstNames should have length 1781)

  it should "read all last names" in (FileReader.lastNames should have length 4761)
